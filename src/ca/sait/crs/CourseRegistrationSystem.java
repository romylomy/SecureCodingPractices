...
public class CourseRegistrationSystem {
    ...
    private void register() {
        ...
        try {
            ...
            studentFactory.build(student);

            
            ProxyRegistrationService ProxyregistrationService = new ProxyRegistrationService();
            Registration registration = ProxyregistrationService.register(student, course);
